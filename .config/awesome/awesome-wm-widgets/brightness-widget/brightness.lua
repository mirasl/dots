...
local function worker(user_args)
    ...
    if program == 'brillo' then
        get_brightness_cmd = 'pkexec /usr/bin/brillo -G'
        set_brightness_cmd = 'pkexec /usr/bin/brillo -S %d' -- <level>
        inc_brightness_cmd = 'pkexec /usr/bin/brillo -A ' .. step
        dec_brightness_cmd = 'pkexec /usr/bin/brillo -U ' .. step
