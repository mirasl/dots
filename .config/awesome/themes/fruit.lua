...
theme.primary_color   = "#643285"
theme.secondary_color = "#933296"
theme.wallpaper_path = "/home/mira/.config/awesome/assets/wallpapers/grape_wallpaper.png"
theme.taskbar_width = 1920 - (26*2)
